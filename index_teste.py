# Esse index é o original quando validamos todo o processo de login, usando importação de estilos
# conforme tela que aparecia. No novo index, tiramos essa mudança de estilos, pois estamos trabalhando
# com o CSS direto
...
app.layout = dbc.Container([
    dbc.Row([
        dbc.Col([
            ...
            html.Audio(autoPlay='autoPlay', controls='controls', src=app.get_asset_url("Audio.mp3"))
                ], md=12)
            ]),
        ], fluid=True)
